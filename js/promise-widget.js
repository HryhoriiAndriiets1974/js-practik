...
// ------ widget ------
import Counter from './class-for-widget.js';
...
const counter4 = new Counter({ selector: '#counter-4', initialValue: -25 });
// ---- question -----
// const date = new Date();
...
const promiseD = makePromise("promiseD value", 2000);
...
Promise.all([promiseA, promiseB])
  ...
  .then(value => console.log(value)) //["promiseA value", .. "promiseD value"]
  .catch(error => console.log(error));
